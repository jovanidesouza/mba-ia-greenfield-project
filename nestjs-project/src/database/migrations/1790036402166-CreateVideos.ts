...
export class CreateVideos1790036402166 implements MigrationInterface {
  name = 'CreateVideos1790036402166';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel_id" uuid NOT NULL, "title" character varying(255) NOT NULL, "description" text, "slug" character varying(32) NOT NULL, "storage_key" character varying(500) NOT NULL, "thumbnail_url" character varying(500), "duration_seconds" integer, "status" "public"."videos_status_enum" NOT NULL DEFAULT 'DRAFT', "error_message" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_5dbcc1ee100f853490582eccc71" UNIQUE ("slug"), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
