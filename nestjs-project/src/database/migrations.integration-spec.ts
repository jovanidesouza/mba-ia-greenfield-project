...
import { CreateVideos1790036402166 } from './migrations/1790036402166-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  afterAll(async () => {
    // Re-apply all migrations so the shared DB is fully migrated for subsequent suites
